...
/**
 * load BreakFast and display to ui
 */
public class BreadActivity extends AppCompatActivity {
    ...
    private String stringUrl="https://api2.bigoven.com/recipes?api_key=axV15293h59oU9Z853fw48CmI1H1Js&any_kw=Bread&&rpp=5&pg=";
    ...
    private class RecipeAsyncTask extends AsyncTask<Void , Void , Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BreadActivity.this);
